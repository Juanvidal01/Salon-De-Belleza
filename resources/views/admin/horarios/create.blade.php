                    ...
                    <form method="POST" action="{{ route('admin.horarios.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="intervalo_minutos" 
                                    ...
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    required>
                                <option value="15" {{ old('intervalo_minutos') == '15' ? 'selected' : '' }}>15 minutos</option>
                                <option value="30" {{ old('intervalo_minutos', '30') == '30' ? 'selected' : '' }}>30 minutos</option>
                                <option value="45" {{ old('intervalo_minutos') == '45' ? 'selected' : '' }}>45 minutos</option>
                                <option value="60" {{ old('intervalo_minutos') == '60' ? 'selected' : '' }}>60 minutos</option>
                            </select>
                            <p class="text-sm text-gray-500 mt-1">Cada cuántos minutos se puede agendar una cita</p>
                        </div>
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-700">Horario Activo (disponible para reservar)</span>
                            </label>
                        </div>
